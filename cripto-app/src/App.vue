	...
	<div class="container mx-auto flex flex-col items-center bg-gray-100 p-4">
		...
		<div class="container">
			...
			<dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
				...
				>
					<div class="px-4 py-5 sm:p-6 text-center">
						...
						<dd class="mt-1 text-3xl font-semibold text-gray-900">{{ ticker.rate }}</dd>
					</div>
			...
			<section class="relative" v-if="selectedTicker">
				...
				<button type="button" class="absolute top-0 right-0" @click="resetSelectedTikcer()">
					<svg
						xmlns="http://www.w3.org/2000/svg"
...
import { AppData, Ticker } from "./App.model";
...
export default defineComponent({
	...
	methods: {
		addTicker() {
			const newTicker = {
				currency: this.tickerSearchName,
				rate: Math.round(Math.random() * 10000) / 100
			};
